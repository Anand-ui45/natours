(() => {
  ...
  var displyMap = (locations) => {
    ...
    const customIcon = L.icon({
      ...
      iconAnchor: [16, 32],
      // Anchor point of the icon [left, top]
      popupAnchor: [0, -32]
    ...
    locations.forEach((loc) => {
      ...
      L.marker([loc.coordinates[1], loc.coordinates[0]], { icon: customIcon }).addTo(map2).bindPopup(`<p>Day ${loc.day}: ${loc.description}</p>`, {
        autoClose: false
      }).openPopup();
    });
